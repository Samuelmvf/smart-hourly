...
export default function SignInPage() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-[40%_60%] w-full h-[100vh] grow items-center sm:justify-center">
      {!isMobile && <div className={`${oswaldFont.className} w-full h-[100vh] bg-yellow-500 flex flex-col items-center justify-center px-4`}>
        ...
        <p className={"text-5xl text-neutral-700 mt-4 text-center"}>Helping you to find your service price</p>
      </div>}
